...
RestApi1::RestApi1(QObject *parent) : QObject(parent)
{
...
void RestApi1::saldo(QString id)
{
...
void RestApi1::saldoSlot(QNetworkReply *reply)
{
...
void RestApi1::tilitapahtumat(QString id)
{
...
void RestApi1::tilitapahtumatSlot(QNetworkReply *reply)
{
...
void RestApi1::nosto(QString idTili, QString idAsiakas, QString summa)
{
...
void RestApi1::nostoSlot(QNetworkReply *reply)
{
    qDebug()<<"nostoSlot()";
    emit nostoReady();
    response_data=reply->readAll();
...
void RestApi1::idAsiakas(QString kortti)
{
    qDebug()<< "idAsiakas()";
    QString site_url="http://localhost:3000/tilitapahtumat/";
...
void RestApi1::idAsiakasSlot(QNetworkReply *reply)
{
...
QString RestApi1::returnResponseData()
{
    return response_data;
}

void RestApi1::idTili(QString kortti)
{
    qDebug()<< "idTili()";
...
void RestApi1::idTiliSlot(QNetworkReply *reply)
{
    qDebug()<< "idTiliSlot()";
    response_data=reply->readAll();
...
void RestApi1::getCardInfo(QString kortti)
{
    qDebug()<< "getCardInfo()";
...
void RestApi1::cardInfoSlot(QNetworkReply *reply)
{
...
void RestApi1::lukittu(QString kortinnumero)
{
...
void RestApi1::lukittuSlot(QNetworkReply *reply)
{
    qDebug()<< "cardLockSlot()";
    emit lukittuReady();
    response_data=reply->readAll();
